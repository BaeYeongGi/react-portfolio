	...
	return (
		<>
			...
			<ul>
				...
				<li>
					가온스) 퍼블리싱 외 추가적인 업무 요구사항으로 기획담당(고객과의 Contact)을 함께 접하게 되었습니다. 퍼블리싱 업무에 집중하고 방향성을 다시잡기 위해 이직을 하게 되었습니다. [1년 2개월]
				</li>
				<li>
...
const Plan = () => {
	return (
		<>
			<p>
				1. Javascript 언어의 본질을 파악하는 프론트앤드 개발자가 되겠습니다. 현업에서 사용하고있는 React.js 또한 Javascript의 라이브러리이며 이전 기업에서도 사용했던 jQuery도
			...
			<br/>
			<p>
				2. create-react-app 방식을 버리고 Next.js를 활용한 프로젝트를
				완성해보고 싶습니다. 클라이언트에서 초기 화면의 렌더링이 지연된다는 점과
				SEO(Search Engine Optimization)에서 콘텐츠 정보 수집에 있어
				불리한 단점을 개선시킨 더 실용적이고 성능이 좋은 페이지를 완성하고,
				더 나아가 Babel혹은 Webpack을 직접 커스마이징 할 수 있는 기회를
				가지고 싶습니다.
			</p>
			<br/>
		</>
